...
if($email == 'admin@qualitybags.co.nz'){
    $_SESSION['adminList'] = '
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="'.HTTP_DIR.'admin/Admin.php?page=BagManagement">Bag Management</a></li>
...
<head>
    ...
    <link rel="stylesheet" href="http://dochyper.unitec.ac.nz/wangc95/php_assignment/lib/bootstrap/dist/css/bootstrap.css" />
    <link rel="stylesheet" href="http://dochyper.unitec.ac.nz/wangc95/php_assignment/css/site.css" />
    <link rel="stylesheet" href="http://dochyper.unitec.ac.nz/wangc95/php_assignment/css/myStyle.css" />
    <link rel="stylesheet" href="http://dochyper.unitec.ac.nz/wangc95/php_assignment/lib/font-awesome/css/font-awesome.css" />
    <link rel="apple-touch-icon" sizes="180x180" href="http://dochyper.unitec.ac.nz/wangc95/php_assignment/favicon/apple-icon-180x180.png">
    <link rel="icon" type="image/png" href="http://dochyper.unitec.ac.nz/wangc95/php_assignment/favicon/favicon-96x96.png" sizes="96x96">
    <link rel="icon" type="image/png" href="http://dochyper.unitec.ac.nz/wangc95/php_assignment/favicon/favicon-32x32.png" sizes="32x32">
    <link rel="icon" type="image/png" href="http://dochyper.unitec.ac.nz/wangc95/php_assignment/favicon/favicon-16x16.png" sizes="16x16">
    <link rel="manifest" href="http://dochyper.unitec.ac.nz/wangc95/php_assignment/favicon/manifest.json">
...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="http://dochyper.unitec.ac.nz/wangc95/php_assignment/index.php" class="navbar-brand"><img style="max-height:28px" src="http://dochyper.unitec.ac.nz/wangc95/php_assignment/images/trans_BG.png" alt="Quality Bags" /></a>
        </div>
    ...
    <?php include ($_SERVER['DOCUMENT_ROOT'].'/wangc95/php_assignment/ShoppingCart.php');?><!--Shopping cart-->
</div>
